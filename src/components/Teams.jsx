        ...
        <div>
          <div className=' items-center justify-center relative overflow-hidden transition duration-300 transform rounded-lg shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Faculty Co-ordinator</p>
        ...
        <div>
          <div className=' items-center justify-center relative overflow-hidden transition duration-300 transform rounded-lg shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>General Secretary</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className=' items-center justify-center relative overflow-hidden transition duration-300 transform rounded-lg shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Mentor</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Jt.General Secretary</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Treasurer</p>
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Head of Sponsorship</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Thrust Secretary</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
                                Lorizzle ipsum bling bling sit amizzle,
                                consectetuer adipiscing elit.
                            </p> */}
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Tech Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>PR Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>NEC Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
                                Lorizzle ipsum bling bling sit amizzle,
                                consectetuer adipiscing elit.
                            </p> */}
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Media Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
                                Lorizzle ipsum bling bling sit amizzle,
                                consectetuer adipiscing elit.
                            </p> */}
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Design Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
                                Lorizzle ipsum bling bling sit amizzle,
                                consectetuer adipiscing elit.
                            </p> */}
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Startup Executive</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
        ...
        <div>
          <div className='relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl'>
            ...
            <div className='absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-black bg-opacity-75 opacity-0 hover:opacity-100'>
              ...
              <p className='mb-4 text-xs text-gray-100'>Aesthetics Head</p>
              {/* <p className="mb-4 text-xs tracking-wide text-gray-400">
